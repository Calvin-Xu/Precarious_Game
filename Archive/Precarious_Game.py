...
# It is good for copying & pasting code to a online service
# And show this game on a mobile device
# Beware that this version is no longer receiving updates
...
Scene_instances = SceneDirector('welcome')
